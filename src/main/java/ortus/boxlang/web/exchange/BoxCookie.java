...
public class BoxCookie implements Cloneable, Serializable {
	...
	public Object clone() {
		try {
			BoxCookie clone = ( BoxCookie ) super.clone();
			if ( attributes != null ) {
	...
	public void setAttribute( String name, String value ) {
		if ( name == null || name.isEmpty() ) {
			throw new IllegalArgumentException( "Cookie attribute name cannot be blank" );
		}

		if ( hasReservedCharacters( name ) ) {
			throw new IllegalArgumentException( "Cookie attribute name is invalid" );
		}
